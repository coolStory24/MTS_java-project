...
public class ReservationResponse {
  ...
  public record FindReservationsForUser(
      List<ReservationRepository.ReservationEntity> reservationsForUser) {}

  public record FindReservationsForRoom(
      List<ReservationRepository.ReservationEntity> reservationsForRoom) {}
